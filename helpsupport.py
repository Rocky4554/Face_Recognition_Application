...
# This part is image labels setting start 
        ...
        # backgorund image 
        bg1=Image.open(r"E:\Final_yar_project\Python_Test_Projects\Images_GUI\bg1.jpg")
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # website button 1
        std_img_btn=Image.open(r"E:\Final_yar_project\Python_Test_Projects\Images_GUI\web.png")
        ...
        # facebook Face  button 2
        det_img_btn=Image.open(r"E:\Final_yar_project\Python_Test_Projects\Images_GUI\fb.png")
        ...
        det_b1_1.place(x=480,y=380,width=180,height=45)
         ...
         # youtube  button 3
        att_img_btn=Image.open(r"E:\Final_yar_project\Python_Test_Projects\Images_GUI\yt.png")
        ...
        att_b1_1.place(x=710,y=380,width=180,height=45)
         ...
         # gmail  Support  button 4
        hlp_img_btn=Image.open(r"E:\Final_yar_project\Python_Test_Projects\Images_GUI\gmail.png")

...
# This part is image labels setting start 
        # first header image  
        img=Image.open(r"E:\Final_yar_project\Python_Test_Projects\Images_GUI\banner1.jpg")
        ...
        # backgorund image 
        bg1=Image.open(r"E:\Final_yar_project\Python_Test_Projects\Images_GUI\t2.jfif")
        ...
        title_lb1 = Label(bg_img,text="Identify People Using Facial Recognition System",font=("verdana",30,"bold"),bg="white",fg="black")
        title_lb1.place(x=0,y=0,width=1540,height=45)

        # Create buttons below the section 
        # ------------------------------------------------------------------------------------------------------------------- 
        # student button 1
        std_img_btn=Image.open(r"E:\Final_yar_project\Python_Test_Projects\Images_GUI\log1.png")
        ...
        std_b1_1 = Button(bg_img,command=self.student_pannels,text="Admin Pannel",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="black")
        ...
        att_b1_1 = Button(bg_img,command=self.attendance_pannel,text="Mark Attendance",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="black")
        ...
        # pho_b1_1 = Button(bg_img,command=self.open_img,text="QR-Codes",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="black")
        ...
        # exi_b1.place(x=940,y=370,width=180,height=180)

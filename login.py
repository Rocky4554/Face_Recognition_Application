...
class Login:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"E:\Final_yar_project\Python_Test_Projects\Images_GUI\loginBg1.jpg")
        ...
        img1=Image.open(r"E:\Final_yar_project\Python_Test_Projects\Images_GUI\log1.png")
        img1=img1.resize((100,100),Image.ANTIALIAS)
        self.photoimage1=ImageTk.PhotoImage(img1)
        lb1img1 = Label(frame1,image=self.photoimage1,bg="#002B53")
        ...
        #entry1 
        self.txtuser=ttk.Entry(frame1,font=("times new roman",15,"bold"),show='*')
        ...
        loginbtn.place(x=40,y=370,width=50,height=20)
...
# This part is image labels setting start 
        ...
        # backgorund image 
        bg1=Image.open(r"E:\Final_yar_project\Python_Test_Projects\Images_GUI\bg3.jpg")
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # student button 1
        std_img_btn=Image.open(r"E:\Final_yar_project\Python_Test_Projects\Images_GUI\std1.jpg")
        ...
        det_img_btn=Image.open(r"E:\Final_yar_project\Python_Test_Projects\Images_GUI\det1.jpg")
        ...
        att_img_btn=Image.open(r"E:\Final_yar_project\Python_Test_Projects\Images_GUI\att.jpg")
        att_img_btn=att_img_btn.resize((280,180),Image.ANTIALIAS)
        self.att_img1=ImageTk.PhotoImage(att_img_btn)

        att_b1 = Button(bg_img,command=self.attendance_pannel,image=self.att_img1,cursor="hand2",)
        att_b1.place(x=940,y=100,width=280,height=180)
        ...
        att_b1_1.place(x=940,y=280,width=280,height=45)

         # Help  Support  button 4
        # hlp_img_btn=Image.open(r"E:\Final_yar_project\Python_Test_Projects\Images_GUI\hlp.jpg")
        ...
        # Start below buttons.........
         # Train   button 5
        tra_img_btn=Image.open(r"E:\Final_yar_project\Python_Test_Projects\Images_GUI\tra1.jpg")
        tra_img_btn=tra_img_btn.resize((280,180),Image.ANTIALIAS)
        self.tra_img1=ImageTk.PhotoImage(tra_img_btn)

        tra_b1 = Button(bg_img,command=self.train_pannels,image=self.tra_img1,cursor="hand2",)
        tra_b1.place(x=250,y=330,width=280,height=180)
        ...
        pho_img_btn=pho_img_btn.resize((280,180),Image.ANTIALIAS)
        self.pho_img1=ImageTk.PhotoImage(pho_img_btn)

        pho_b1 = Button(bg_img,command=self.request,image=self.pho_img1,cursor="hand2",)
        pho_b1.place(x=580,y=330,width=280,height=180)

        pho_b1_1 = Button(bg_img,command=self.request,text="Generate new Admin",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        pho_b1_1.place(x=580,y=510,width=280,height=45)
        ...
        # exit   button 8
        exi_img_btn=Image.open(r"E:\Final_yar_project\Python_Test_Projects\Images_GUI\exi.jpg")
        ...
        exi_b1.place(x=940,y=330,width=280,height=180)
        ...
        #button to frontpage
        # dev_b1_1 = Button(bg_img,command=self.frontview,text="Developers",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        # dev_b1_1.place(x=100,y=510,width=180,height=45)
...
# ==================Functions Buttons=====================
    ...
    def frontview(self):
        self.new_window=Toplevel(self.root)
        self.app=Frontview(self.new_window)
